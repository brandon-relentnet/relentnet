  ...
  return (
    <div className="min-h-screen bg-page text-ink font-sans selection:bg-gold selection:text-black overflow-hidden">
      ...
      <section className="pt-48 pb-24 px-4 flex flex-col justify-center items-center relative">
        ...
        <p className="mt-8 max-w-2xl text-center text-ink-sub font-light text-lg leading-relaxed animate-fade-in-up delay-200">
      ...
      {/* STEPS SECTION */}
      <section className="py-24  px-6 md:px-20 relative z-10 bg-surface backdrop-blur-xs border-y border-line">
        <div className="max-w-5xl mx-auto space-y-24">
          ...
          >
            ...
            <div className="order-1 md:order-2 flex justify-center md:justify-end">
              <div className="text-9xl font-serif text-black/15 dark:text-white/30 group-hover:text-gold/70 transition-colors duration-500">
                01
              </div>
            </div>
          </div>
